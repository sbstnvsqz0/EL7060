...
def get_args():
    ...
    parser.add_argument("--hidden_size","-hs",type=int,default=64,help="Neuronas en capa oculta de RNN")
    parser.add_argument("--num_rnn_layers","-nrnn",type=int,default=1,help="Número capas RNN")
